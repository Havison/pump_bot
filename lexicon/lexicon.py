...
LEXICON_TEXT: dict[str, str] = {'setting_text': '<b>🔧Настройки 🟢ПАМП и 🔴ДАМП сигналов, текущие настройки:\n\n '
                                                '🟢ПАМП: {changes_long} % за {interval_long} минут🟢\n\n'
                                                '🔴ДАМП: {changes_short} % за {interval_short} минут🔴\n\n'
                                                '🧿Количество сигналов за {quantity_interval} {hours_text}: '
                                                '{quantity_setting} 🧿</b>',
                                'setting_text_start': '<b>🔧Настройки 🟢ПАМП и 🔴ДАМП сигналов текущие настройки:\n\n'
                                                      '🟢ПАМП: {changes_long} % за {interval_long} минут🟢\n\n'
                                                      '🔴ДАМП: {changes_short} % за {interval_short} минут🔴\n\n'
                                ...
                                'warning_long_changes': '📛<b>Рост цены должено быть целым числом от 1 до 9999</b>📛\n\n'
                                                        ...
                                                        ' - нажмите кнопку "❌<b>Отмена настроек</b>❌"',
                                'warning_short_changes': '📛<b>Падения цены должено быть целым числом от 1 до 9999</b>📛\n\n'
                                                         'Попробуйте еще раз\n\n'
                                                         'Если вы хотите прервать настройку 🔴ДАМПа🔴 - нажмите кнопку "❌<b>Отмена настроек</b> ❌"',
                                'warning_interval': '📛<b>Интервал времени должен быть целым числом от 1 до 240</b>📛\n\n'
                                                    'Попробуйте еще раз\n\n'
                                                    'Если вы хотите прервать настройку интервала времени - нажмите кнопку "❌<b>Отмена настроек</b> ❌"',
                                ...
                                'quantity_warning': 'Выберите период или нажмите кнопку "❌<b>Отмена настроек</b>❌"',
                                ...
                                'fail_premium': '<b>Подписка отсутсвует, по вопросом подписки пишите @havison</b>'
