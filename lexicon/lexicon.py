...
LEXICON_TEXT: dict[str, str] = {'setting_text': '<b>🔧Текущие настройки:🔧\n\n '
                                ...
                                'help': '<b>Это бот для сигналов роста и падение цены.\n'
                                        'После первого старта вам доступна бесплатная подписка 2 дня, которую можно активировать командой /pay или в разделе <b>🔐Подписка.</b>\n'
                                        ...
                                        'Все настройки позиций устаналиваются отправокй целых положительных чисел в чат,'
